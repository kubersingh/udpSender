...
namespace udpSender
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            #endregion
            Console.WriteLine("Enter IP address to send, blank line to quit");
            string Ip_tosend = Console.ReadLine();
            Console.WriteLine("Enter port to send, blank line to quit");
            int port_tosend = Convert.ToInt32(Console.ReadLine());
            if (Ip_tosend.Length == 0 || port_tosend == 0)
            {
                done = true;
            }
            IPAddress send_to_address = IPAddress.Parse(Ip_tosend);
            #region comments
            ...
            #endregion
            IPEndPoint sending_end_point = new IPEndPoint(send_to_address, port_tosend);
            #region comments
